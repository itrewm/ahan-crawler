...
class AsroonTableSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        milgerd = [
            'آجدار@https://www.asroon.ir/products/rebar/',
    ...
    def navdani_parse(self, response):
        ...
        for res in response.xpath('//table[@class="table"'):
    ...
    def tirahan_parse(self, response):
        #for res in response.xpath('//table[re:test(@class, "table")]'):
        for res in response.css('table.TableList_container__1HOjj'):
    ...
    def milgerd_parse(self, response):
        ...
        for res in response.css('table.table.table'):
            print(res)
            ...
            #             'price' : row.xpath('td[7]//span//text()').extract_first(),
            #             'arzesh-afzoode' : row.xpath('td[8]//span//text()').extract_first(),
